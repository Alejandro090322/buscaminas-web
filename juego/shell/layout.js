 ...
 * presentación compartida por los 3 niveles del shell (Principiante,
 * Intermedio, Experto). Lee filas/columnas de data-filas/data-columnas en
 * #bm-board (fijadas por juego/shell/niveles.js antes de que este script
 * se cargue), así que no hace falta tocar nada aquí al añadir un nivel
 * nuevo.
 *
...
(function () {
  ...
  // exacto, constante para todas las casillas hasta el próximo recálculo.
