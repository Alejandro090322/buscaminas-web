/*
 * Buscaminas Experto — motor puro del tablero (nivel Principiante: 9x9, 10 minas).
 * Sin dependencias del DOM: solo estado y funciones sobre ese estado, para que
 * sea reutilizable y testeable de forma aislada. El renderizado vive en render.js.
 */
...
(function (global) {
  ...
  global.BuscaminasBoard = {
    ...
    COLUMNAS: COLUMNAS,
    MINAS: MINAS,
    crear: function () { return crearTablero(FILAS, COLUMNAS, MINAS); },
    clic: clic,
    clicDoble: clicDoble,
